...
export const site = {
  ...
  ticker: [
    ...
    "Across the Caribbean, one generation",
  ...
  stats: {
    ...
    items: [
      ...
      { num: "25", label: "Nations & territories", note: "The Caribbean countries and territories in the network's scope, and growing." },
    ],
  },
  ...
  memberStates: {
    eyebrow: "Across the Caribbean",
    title: "Nations & Territories",
    lead: "The Caribbean nations and territories the network is being built across, from independent states to overseas territories. This list isn't exhaustive, and as the network grows we plan to include more.",
    items: [
      { country: "Anguilla", capital: "The Valley", iso: "ai" },
      { country: "Antigua & Barbuda", capital: "St. John's", iso: "ag" },
      { country: "Aruba", capital: "Oranjestad", iso: "aw" },
      ...
      { country: "Bermuda", capital: "Hamilton", iso: "bm" },
      { country: "British Virgin Islands", capital: "Road Town", iso: "vg" },
      { country: "Cayman Islands", capital: "George Town", iso: "ky" },
      { country: "Cuba", capital: "Havana", iso: "cu" },
      { country: "Curaçao", capital: "Willemstad", iso: "cw" },
      { country: "Dominica", capital: "Roseau", iso: "dm" },
      { country: "Dominican Republic", capital: "Santo Domingo", iso: "do" },
      ...
      { country: "Sint Maarten", capital: "Philipsburg", iso: "sx" },
      { country: "Suriname", capital: "Paramaribo", iso: "sr" },
      { country: "Trinidad & Tobago", capital: "Port of Spain", iso: "tt" },
      { country: "Turks & Caicos Islands", capital: "Cockburn Town", iso: "tc" },
    ],
  },
